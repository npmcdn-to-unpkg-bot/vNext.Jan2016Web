...
{
    /// <summary>
    /// Serializes and deserializes Twitter2 request and access tokens so that they can be used by other application components.
    /// </summary>
    public class RequestTokenSerializer : IDataSerializer<RequestToken>
    {
        ...
        /// <returns>The Twitter2 request token</returns>
        [SuppressMessage("Microsoft.Usage", "CA2202:Do not dispose objects multiple times", Justification = "Dispose is idempotent")]
        ...
        /// <summary>
        /// Writes a Twitter2 request token as a series of bytes. Used by the <see cref="Serialize"/> method.
        /// </summary>
        ...
        /// <summary>
        /// Reads a Twitter2 request token from a series of bytes. Used by the <see cref="Deserialize"/> method.
        /// </summary>
