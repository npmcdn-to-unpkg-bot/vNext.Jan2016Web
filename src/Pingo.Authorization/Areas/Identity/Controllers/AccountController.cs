...
using Pingo.Authorization.Services;
using Pingo.Authorization.ViewModels.Account;

namespace Pingo.Authorization.Areas.Identity.Controllers
{
    [Area("Identity")]
    [Authorize]
    public class AccountController : Controller
    {
        ...
        private readonly Microsoft.AspNet.Identity.SignInManager<ApplicationUser> _signInManager;
