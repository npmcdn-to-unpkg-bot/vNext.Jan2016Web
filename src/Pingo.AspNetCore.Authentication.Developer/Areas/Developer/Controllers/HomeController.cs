...
using Pingo.AspNetCore.Authentication.Developer.Models;
...
namespace Pingo.AspNetCore.Authentication.Developer.Areas.Developer.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            var token = Request.Cookies[DeveloperHandler.StateCookie];
            var data = DeveloperOptions.StateDataFormat.Unprotect(token);
